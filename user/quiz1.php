...
mysqli_data_seek($rs,$_SESSION[qn]);
$row= mysqli_fetch_row($rs);
$sb_ex=mysqli_query($cn,"select * from mst_test as t,mst_subject as s where t.sub_id=s.sub_id and test_id=20") or die(mysqli_error());
			    ...
			    <div class="card border-left-primary shadow col-md-12">
					<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<button type="submit" name="submit" class="btn btn-warning" style="color:#fff;font-weight:bold;">10:00</button>
								</div>
							</div>	
							<hr>
							...
							<?php
								if($_SESSION[qn]<mysqli_num_rows($rs)-1){
							?>
								<button type="submit" name="submit" class="btn btn-success" value="Next Question">Next Question</button>
							<?php
							}
							else{
								?>
								<button type="submit" name="submit" class="btn btn-success" value="Get Result">Get Result</button>
							<?php
							}
							?>
							<br>
